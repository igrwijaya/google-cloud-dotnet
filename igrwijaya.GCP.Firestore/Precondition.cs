...
namespace igrwijaya.GCP.Firestore
{
    ...
    public sealed class Precondition
    {
        ...
        /// </summary>
        public static Precondition MustExist { get; } = new Precondition(new Google.Cloud.Firestore.V1.Precondition { Exists = true });
        ...
        /// </summary>
        internal static Precondition MustNotExist { get; } = new Precondition(new Google.Cloud.Firestore.V1.Precondition { Exists = false });
        ...
        public static Precondition LastUpdated(Timestamp timestamp) =>
            new Precondition(new Google.Cloud.Firestore.V1.Precondition { UpdateTime = timestamp.ToProto()});
        ...
        /// </summary>
        internal Google.Cloud.Firestore.V1.Precondition Proto { get; }

        private Precondition(Google.Cloud.Firestore.V1.Precondition proto) => Proto = proto;

        // Only used by tests
        internal static Precondition FromProto(Google.Cloud.Firestore.V1.Precondition proto) => proto == null ? null : new Precondition(proto);
    }
}
